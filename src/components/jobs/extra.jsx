...
const RemoteJobList = () => {
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 min-h-screen">
      {/* Hero section - Fixed dark mode colors */}
      <div className="max-w-6xl mx-auto px-4 mt-16">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm dark:shadow-gray-700/20 p-6">
          ...
          {/* Enhanced Search bar in hero - Fixed dark mode colors */}
          <div className="bg-white dark:bg-gray-800 rounded-xl p-5 shadow-lg dark:shadow-gray-700/10">
            <div className="flex flex-col md:flex-row gap-4">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400"
                  value={searchTerm}
              ...
              <div className="relative w-full md:w-64">
                ...
                <select
                  className="w-full pl-10 pr-4 py-3 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400"
            ...
            {/* Added profile-based suggestions - Fixed dark mode colors */}
            <div className="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700">
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-2">
                Recommended based on your profile:
              </p>
              <div className="flex flex-wrap gap-2">
                <button className="px-3 py-1 bg-gray-100 dark:bg-gray-700 text-blue-700 dark:text-blue-400 hover:bg-gray-200 dark:hover:bg-gray-600 rounded-full text-sm transition-colors">
      ...
      {/* Updated Stats bar - Fixed dark mode colors */}
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="bg-white dark:bg-gray-800 p-5 rounded-lg shadow-sm mb-6 flex flex-wrap justify-between items-center border-l-4 border-blue-500 dark:border-blue-400">
          <div>
          ...
          <div className="lg:col-span-2 space-y-4">
            {filteredJobs.length > 0 ? (
              filteredJobs.map((job) => (
                <div
                  key={job.id}
                  className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden transition-all duration-200 hover:shadow-md"
                >
                  <div
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex flex-col items-end gap-2 flex-shrink-0">
                        ...
                        {/* Toggle button - Improved with transition effect */}
                        <button className="mt-2 flex items-center text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors duration-200">
                    ...
                    <div className="px-5 pb-5 border-t border-gray-200 dark:border-gray-700 pt-4">
                      ...
                      <div className="flex justify-end">
                        <a
                          ...
                          className="px-5 py-2 bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white rounded-lg transition-colors duration-300 font-medium"
                        >
                          Apply Now
                        </a>
                      </div>
              ...
              <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                ...
                <ul className="space-y-3 text-sm text-gray-600 dark:text-gray-400">
                  <li className="flex items-start gap-2">
                    <div className="w-5 h-5 rounded-full bg-blue-100 dark:bg-blue-900/50 flex items-center justify-center text-blue-700 dark:text-blue-300 flex-shrink-0 mt-0.5">
      ...
      {/* Footer with improved dark mode colors */}
